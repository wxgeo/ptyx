...
\section{Section 2}
\begin{enumerate}[resume] % (questions) % shuffle questions
\item
...
\sloppy\stepcounter{answerNumber}\graysquared{\alph{answerNumber}}~~\mbox{E}\qquad\linebreak[3]%
...
\stepcounter{answerNumber}\graysquared{\alph{answerNumber}}~~\mbox{N}\qquad\linebreak[3]%
