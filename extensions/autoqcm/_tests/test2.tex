        ...
        \draw[fill=black] (0,0) rectangle (1,1);
            ...
            \draw[fill=white] (7,0) rectangle (8,1);
            \draw[fill=white] (8,0) rectangle (9,1);
            \draw[fill=white] (9,0) rectangle (10,1);
            \draw[fill=white] (10,0) rectangle (11,1);
        ...
        \begin{scriptsize}\hfill\textsc{Ne rien écrire ci-dessus.}\hfill\hfill\hfill\textsc{Ne rien écrire ci-dessus.}\hfill\hfil\end{scriptsize}
            ...
            \draw [fill=black] (-2,0) rectangle (-1,1) (-1.5,0) node[below] {\tiny\rotatebox{-90}{\texttt{\textbf{Cochez le nom}}}};\draw[fill=white] (0,0) rectangle (1,1) (0.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{ZERROUG Inès}}};\draw[fill=white] (2,0) rectangle (3,1) (2.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{ZAGAR Valerie}}};\draw[fill=white] (4,0) rectangle (5,1) (4.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{VONESCHEN Ale.}}};\draw[fill=white] (6,0) rectangle (7,1) (6.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{TRIPODI Quent.}}};\draw[fill=white] (8,0) rectangle (9,1) (8.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{TOUZANI Guill.}}};\draw[fill=white] (10,0) rectangle (11,1) (10.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{TOUZANI Antoi.}}};\draw[fill=white] (12,0) rectangle (13,1) (12.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{TIOLET Sarra}}};\draw[fill=white] (14,0) rectangle (15,1) (14.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{THAON Sylvain}}};\draw[fill=white] (16,0) rectangle (17,1) (16.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{TCHERGUIZOVA}}};\draw[fill=white] (18,0) rectangle (19,1) (18.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{SINGHARATH Au.}}};\draw[fill=white] (20,0) rectangle (21,1) (20.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{SFRAGARO Carla}}};\draw[fill=white] (22,0) rectangle (23,1) (22.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{SEZILLE Lea}}};\draw[fill=white] (24,0) rectangle (25,1) (24.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{SCARDINA Glor.}}};\draw[fill=white] (26,0) rectangle (27,1) (26.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{REVIRON Cesar}}};\draw[fill=white] (28,0) rectangle (29,1) (28.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{PETILLON Tommy}}};\draw[fill=white] (30,0) rectangle (31,1) (30.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{PALAGONIA Bet.}}};\draw[fill=white] (32,0) rectangle (33,1) (32.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{MARTINEZ Mari.}}};\draw[fill=white] (34,0) rectangle (35,1) (34.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{LONGORDO Elod.}}};\draw[fill=white] (36,0) rectangle (37,1) (36.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{HERBULOT Juli.}}};\draw[fill=white] (38,0) rectangle (39,1) (38.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{HAJJAJI Ahmed}}};\draw[fill=white] (40,0) rectangle (41,1) (40.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{GRAFFAGNINO M.}}};\draw[fill=white] (42,0) rectangle (43,1) (42.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{GARINO Maxime}}};\draw[fill=white] (44,0) rectangle (45,1) (44.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{ERRIADI Izia}}};\draw[fill=white] (46,0) rectangle (47,1) (46.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{DEMARTY Khadi.}}};\draw[fill=white] (48,0) rectangle (49,1) (48.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{DELLAMONICA M.}}};\draw[fill=white] (50,0) rectangle (51,1) (50.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{CONSTANT Chloé}}};\draw[fill=white] (52,0) rectangle (53,1) (52.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{CHARMAN Adrien}}};\draw[fill=white] (54,0) rectangle (55,1) (54.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{CELESTINI Yas.}}};\draw[fill=white] (56,0) rectangle (57,1) (56.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BOVIS Yasmina}}};\draw[fill=white] (58,0) rectangle (59,1) (58.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BOUCHET Coren.}}};\draw[fill=white] (60,0) rectangle (61,1) (60.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BIETTE Youssef}}};\draw[fill=white] (62,0) rectangle (63,1) (62.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BIANCHI Laura}}};\draw[fill=white] (64,0) rectangle (65,1) (64.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BAILLIE Coral.}}};\draw[fill=white] (66,0) rectangle (67,1) (66.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{BAILET Rania}}};\draw[fill=white] (68,0) rectangle (69,1) (68.5,0) node[below]
                    {\tiny \rotatebox{-90}{\texttt{ABOUKORA Elod.}}};\draw[rounded corners] (-3,2) rectangle (70, -6.5);
            \draw[] (-0.5,2) -- (-0.5,-6.5);
            \end{tikzpicture}
            \end{center}
            \vspace{-1em}
        ...
        \draw[fill=black] (-1,0) rectangle (0,1);
        \draw (0,0) rectangle (1,1) (0.5,0.5) node {1};
            \draw (1,0) rectangle (2,1) (1.5,0.5) node {2};
            \draw (2,0) rectangle (3,1) (2.5,0.5) node {3};
            \draw (3,0) rectangle (4,1) (3.5,0.5) node {4};
            \draw (4,0) rectangle (5,1) (4.5,0.5) node {5};
            \draw (5,0) rectangle (6,1) (5.5,0.5) node {6};
            \draw (6,0) rectangle (7,1) (6.5,0.5) node {7};
            \draw (7,0) rectangle (8,1) (7.5,0.5) node {8};
            \draw (8,0) rectangle (9,1) (8.5,0.5) node {9};
            ...
            \draw (-1,-5) rectangle (0,-6) (-0.5,-5.5) node {f};
            ...
            \draw (-1,-6) rectangle (0,-7) (-0.5,-6.5) node {g};
            ...
            \draw (-1,-7) rectangle (0,-8) (-0.5,-7.5) node {h};
